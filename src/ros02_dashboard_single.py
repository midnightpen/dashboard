...
def setup_dash_app():
    ...
    row = html.Div(
        [
            ...
            dbc.Row(
                [
                    dbc.Col(daq.Gauge(id="progress-gauge1",min = 0,max = 200, showCurrentValue = True,
                                      label = {'label': 'Current','style': {'font-size': '25px',"color": "#8dd7f9"}},
                                      units='Current', size=120)),
                    dbc.Col(daq.Gauge(id="progress-gauge2",min = 0,max = 100, showCurrentValue = True,
                                      label = {'label': 'Radio Link','style': {'font-size': '25px',"color": "#8dd7f9"}},
                                      units='dBm', size=120)),
                    dbc.Col(daq.Gauge(id="progress-gauge3",min = 0,max = 150, showCurrentValue = True,
                                      label = {'label': 'CPU Load','style': {'font-size': '25px',"color": "#8dd7f9"}},
                                      units='Average', size=120)),
                ],align="center"),

            dbc.Row(
                [
                    dbc.Col(daq.Gauge(color=theme['primary'],id='darktheme-daq-gauge1',className='dark-theme-control',
                                      min = 0, max = 200, showCurrentValue=True,  
                                      label = {'label': 'Battery Voltage','style': {'font-size': '25px',"color": "#8dd7f9"}},
                                      units='')),
                    dbc.Col(daq.Gauge(color=theme['primary'],id='darktheme-daq-gauge2',className='dark-theme-control',
                                      min = 0, max = 100, showCurrentValue=True,  
                                      label = {'label': 'Nearest Hazard','style': {'font-size': '25px',"color": "#8dd7f9"}},
                                      units='')),
                ],
                align="center",
            ),
