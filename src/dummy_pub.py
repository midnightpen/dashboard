...
#config_path = os.path.join(jsonpath)
config_path = os.path.join('/home','sky','catkin_ws','src','dashboard','src','config.json')
#helper function
...
#/home/sky/catkin_ws/src/dashboard/cfg
# config_path = os.path.join('/home','sky','catkin_ws','src','dashboard','cfg','config.json')
